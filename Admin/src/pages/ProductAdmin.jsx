                ...
                <div key={i} className="relative">
                  <img
                    ...
                    className={`w-28 h-28 object-cover rounded-lg border ${
                      selectedSubIndex === i ? "border-blue-700" : ""
                    }`}
                  />
                  <span
                    className="absolute top-1 left-1 bg-blue-700 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs cursor-pointer"
